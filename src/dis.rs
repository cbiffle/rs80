//! An 8080 disassembler generated from the same tables that produce the
//! instruction dispatch routines (so it's very likely to match the emulator's
//! view of the world).
...
static INSN_INFO: [InsnInfo; 256] = {
        ...
        // Actual table is generated by build.rs.
        include!(concat!(env!("OUT_DIR"), "/disassemble.rs"))
};

/// Disassembles a single struction from the prefix of `bytes`, writing a line
/// of text (without trailing newline!) to `out`.
///
