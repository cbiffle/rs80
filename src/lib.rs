...
fn sub(a: W8, b: W8, c: u8, flags: &mut Flags) -> W8 {
    ...
    flags.carry = sum16 & 0x100 != 0;
    flags.parity = sum8.count_ones() % 2 == 0;
    flags.aux = (Wrapping(a.0 & 0xF) + Wrapping(!b.0 & 0xF)
        + Wrapping(1 - c)).0 & 0x10 != 0;
